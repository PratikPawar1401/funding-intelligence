...
def get_config() -> Config:
    ...
    return Config(
        ...
        cosine_thresholds=__import__('json').loads(_env("COSINE_THRESHOLDS", '{"method": 0.40, "population": 0.35, "research_domain": 0.35, "research_discipline": 0.35, "sponsor_theme": 0.30, "default": 0.35}')),
